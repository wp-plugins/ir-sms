<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/plugins/<?=WP_SMS_DIRNAME;?>/css/style.css" />
<?php if(get_option('wp_call_jquery')) { ?>
<script src="<?php bloginfo('url'); ?>/wp-content/plugins/<?=WP_SMS_DIRNAME;?>/js/jquery-1.7.2.min.js" type="text/javascript"></script>
<?php } ?>
<script type="text/javascript">
	$(document).ready(function()
	{
		$("#submit_newsletter").click(function()
		{
			...
			$("#show_result").html('<img src="<?php bloginfo('url'); ?>/wp-content/plugins/<?=WP_SMS_DIRNAME;?>/images/loading.gif"/>');
...
<table id="subscribe">
	...
	<tr>
		<td colspan="2">
		<p align="center"><img src="<?php bloginfo('url'); ?>/wp-content/plugins/<?=WP_SMS_DIRNAME;?>/images/close.png"/></p>
